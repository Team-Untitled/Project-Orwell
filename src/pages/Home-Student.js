...
<div class="home-grid-container">
    <div class="d1">
        <p style={{fontFamily:"Agency FB", fontSize:"80px", fontWeight: "bold", marginTop: "-20px", marginLeft:"10px", color: "#b1b7b9"}}>
            Welcome to
            <span style={{color: "#007399"}}>Project-Orwell - Student </span>
        </p>
    </div>
    ...
    <div class="d3">
        <img src="assets/images/stu-reco22.gif" style={{margin: "0px 50px 50px -50px", height: "100%", width: "100%"}}/>
    </div>
    <div class="d4">
        <Link to="/Join"><a href="welcome.html">
        ...
        <Link to="/Profile-Student"><a href="welcome.html">
        ...
        <Link to="/About-Student"><a href="welcome.html">
            <button class="btn btn-success">
            <span class="icon">
        ...
        <Link to="/Help-Student"><a href="welcome.html">
            <button class="btn btn-success">
            <span class="icon">
